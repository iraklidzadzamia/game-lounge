...
export default function FloorMap({ selectedSeats, onToggle, unavailableIds = [], branchId }: FloorMapProps) {
    ...
    const renderChikovaniLayout = () => (
        <div className="w-full flex flex-col gap-8 p-0 md:p-4 items-center xl:items-start">
            ...
            <div className="w-full glass-panel p-6 rounded-xl border border-white/10 relative aspect-square flex flex-col justify-between mx-auto xl:ml-0 xl:w-full xl:max-w-[380px]">
