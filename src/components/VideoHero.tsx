            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 text-center">
                ...
                >
                    <button
                        ...
                        className="group flex flex-col items-center gap-2 px-10 py-4 bg-neon-cyan text-black font-orbitron font-bold tracking-wider rounded-2xl hover:bg-white transition-all duration-300 shadow-[0_0_20px_rgba(0,243,255,0.4)] hover:shadow-[0_0_40px_rgba(0,243,255,0.6)] hover:-translate-y-1 transform active:scale-95"
                    >
                        <span className="text-xl">GET IN TOUCH</span>
                        {/* Channel icons row inside the button */}
                        <span className="flex items-center gap-3 opacity-80 group-hover:opacity-100 transition-opacity">
                            {/* WhatsApp */}
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-label="WhatsApp">
                            ...
                            {/* Messenger */}
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-label="Messenger">
