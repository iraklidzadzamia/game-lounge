...
export default function BookingPage({ params }: { params: { branch: string } }) {
    ...
    return (
        <main className="min-h-screen bg-void pt-24 pb-12 px-4 md:px-8 relative overflow-hidden">
            ...
            <div className="flex flex-col gap-8 pb-32 md:pb-0 w-full max-w-[1280px] mx-auto">

                {/* Step 1: Time & Date (Order 1) */}
                <section className="glass-card p-6 md:p-8 space-y-8 order-1">
                    {/* Date Selection */}
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <div className="relative flex-1">
                                ...
                                {isDatePickerOpen && (
                                    <div className="fixed inset-0 z-40 bg-transparent" onClick={() => setIsDatePickerOpen(false)} />
                                )}
                            </div>
                        </div>
                ...
                {/* Booking Summary - Order 2 on Desktop, Order 3 on Mobile */}
                ...
                {/* Step 2: Seat Selection (Order 2 on Mobile, Order 3 on Desktop) */}
                <section className="glass-card p-6 md:p-8 min-h-[500px] order-2 lg:order-3">
